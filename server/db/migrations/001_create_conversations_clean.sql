-- Clean Migration: Create conversations table for amora_db
-- This migration only creates conversations-related tables
-- Assumes users and companions tables already exist

USE amora_db;

-- Drop existing conversations-related tables if they exist (for clean migration)
...
CREATE TABLE conversations (
    ...
    -- Foreign key constraints (references existing tables)
