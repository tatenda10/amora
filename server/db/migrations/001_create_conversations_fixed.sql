-- Fixed Migration: Create conversations table for amora_db
-- This migration fixes the foreign key constraint issues and circular dependencies
-- Assumes users and companions tables already exist
...
-- Create conversations table (without foreign key to messages initially)
CREATE TABLE conversations (
    ...
    -- Foreign key constraints (only to existing tables)
